...
<div class="container-fluid py-4">
  ...
  <div class="row mb-4">
    <form autocomplete="off" class="row">
      ...
      <div class="col-md-3 mb-3 d-flex align-items-end">
        <button type="button" id="btn-stockStatus" class="btn btn-primary w-100 mt-4">Lọc kết quả</button>
      </div>
    </form>
  </div>
  ...
  <div class="row mb-4">
    <div class="col-md-12">
      <div id="myInventori" class="bg-light" style="height: 250px;"></div>
    </div>
  </div>

  <div class="col-sm-12">
    <p class="display-4 text-center text-dark font-weight-bold mb-4">
        <i class="fas fa-cogs"></i> Thống kê hàng tồn kho
    </p>
    <table class="table table-bordered table-striped table-hover" id="stockStatus">
        <thead class="table-dark">
            <tr>
                <th><i class="fas fa-cogs"></i> Tên sản phẩm</th>
                <th><i class="fas fa-box"></i> Hàng tồn kho</th>
                <th><i class="fas fa-dollar-sign"></i> Giá</th>
                <th><i class="fas fa-tshirt"></i> Size</th>
                <th><i class="fas fa-paint-brush"></i> Màu</th>
            </tr>
        </thead>
        <tbody>
