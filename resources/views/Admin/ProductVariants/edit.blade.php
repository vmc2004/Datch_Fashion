                        ...
                        <form action="{{ route('productVariants.update',$productVariant->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <select id="status" name="color_id"
                                    ...
                                    @foreach ($colors as $color )
                                        <option value="{{$color->id}}" {{$color->id?'selected':''}}>{{$color->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="status" name="size_id"
                                    ...
                                    @foreach ($sizes as $size )
                                        <option value="{{$size->id}}" {{$size->id?'selected':''}}>{{$size->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="quantity"
                                    class="form-control @error('quantity') is-invalid @enderror" value="{{ old('quantity',$productVariant['quantity']) }}">
                                @error('quantity')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="price"
                                    class="form-control @error('price') is-invalid @enderror" value="{{ old('price',$productVariant['price']) }}">
                                @error('price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="sale_price"
                                    class="form-control @error('sale_price') is-invalid @enderror" value="{{ old('sale_price',$productVariant['sale_price']) }}">
                                @error('sale_price')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="image"
                                    class="form-control @error('image') is-invalid @enderror" value="{{ old('image',$productVariant['image']) }}">
                                @error('image')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
