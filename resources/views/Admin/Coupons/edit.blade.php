    ...
    @endif
        ...
        <form method="POST" action="{{ route('coupons.update', $coupon) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="quantity" class="form-control" id=""  value="{{$coupon->quantity}}">
            </div>


            <div class="mb-3">
                <label for="" class="form-label">Ngày bắt đầu</label>
                <input type="date" name="start_date" class="form-control" id=""  value="{{$coupon->start_date}}">
            </div>
