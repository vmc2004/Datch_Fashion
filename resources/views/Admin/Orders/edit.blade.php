                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="border">
                            @foreach ($order->OrderDetails as $detail)
                                <tr>
                                    <td class="text-center">{{ $detail->variant->product->name }} -
                                        {{ $detail->variant->color->name }} - {{ $detail->variant->size->name }}</td>
                            ...
                            <table class="table table-borderless">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            {{ number_format($order->OrderDetails->sum(function ($detail) {return $detail->quantity * $detail->variant->price;})) }}
                                            ₫</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end fw-bold text-primary">{{ number_format($order->total_price) }}
                                            ₫</td>
                                    </tr>
                                    <tr>
                                        <td class="text-end"><strong>Trạng thái thanh toán:</strong></td>
                                        <td class="text-end">{{ $order->payment_status }}</td>
                                    </tr>
                                    <tr>
                                        <td class="text-end"><strong>Trạng thái :</strong></td>
                                        <td class="text-end">{{ $order->status }}</td>
                                    </tr>
                                    @if ($order->status == 'Đơn hàng đã hủy')
                                        <tr>
                                            <td class="text-end"><strong>Lí do:</strong></td>
