            ...
            <ul class="nav flex-column ms-4 collapse" id="productManagement">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('comments.index') }}">
                        <div class="icon icon-shape border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="14" width="14" viewBox="0 0 512 512">
                                <path d="M448 64c-35.3 0-64 28.7-64 64s28.7 64 64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32zm0 256c-35.3 0-64 28.7-64 64s28.7 64 64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32zm-256 64c-35.3 0-64 28.7-64 64s28.7 64 64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32zm0-256c-35.3 0-64 28.7-64 64s28.7 64 64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32zm-128 256c-35.3 0-64 28.7-64 64s28.7 64 64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32zm-64-320c-35.3 0-64 28.7-64 64s28.7 64 64 64c17.7 0 32-14.3 32-32s-14.3-32-32-32z"/>
                            </svg>
                        </div>
