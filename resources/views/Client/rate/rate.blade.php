        ...
        <div class="col-span-4">
            ...
            <div>
                    ...
                    <table class="table-auto w-full border-collapse border border-gray-300">
                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-100">
                                <td class="px-4 py-2 border border-gray-300 text-center">{{$variant->product->code}}</td>
                ...
                <div class="border border-gray-300 rounded-lg shadow-lg">
                    ...
                    <form action="{{ route('comments.sendComment', $variant->product_id) }}" method="POST" class="comment-form w-100 my-3">
                        @csrf
