                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <section>
                                                <div role="presentation" tabindex="0" class="outline-none">
                                                    <input id="avatarInput" name="avatar" accept="image/*" multiple=""
                                                        type="file" tabindex="-1" style="display: none;">
                                                    <div class="inline-block ml-auto relative group">
                                                        <img id="avatarPreview"
                                                            src="{{ $user->avatar ? '/uploads/' . $user->avatar : '/assets/images/no-avatar.svg' }}"
                                    ...
                                    <div class="relative mb-8">
                                        <div class="flex flex-wrap items-center">
                                            ...
                                            <div class="flex items-center cursor-pointer mr-8">
                                                <input type="radio" name="gender" value="Nam" class="mr-2"
