...
<div
            ...
            <div>
                <h2 class="text-gray-800 text-3xl font-extrabold text-center">DATCH FASHION</h2>
                @if(session('success'))
                    <div class="bg-green-100 text-green-500 p-3 rounded-md">{{ session('success') }}</div>
                @endif

                <form action="{{ route('Client.updateContact') }}" method="POST">
                    @csrf
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="content" id="content" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required=""></textarea>
                    </div>
                ...
                <ul class="mt-4 flex flex-wrap justify-center gap-6">
                    ...
                    <li class="flex items-center text-blue-600">
                        ...
                        <a href="javascript:void(0)" class="text-sm ml-4">
                            <strong>+84 365901822</strong>
                        </a>
                    </li>
                </ul>
            </div>
            <div class="z-10 relative h-full max-md:min-h-[350px]">
                <iframe src="https://maps.google.com/maps?q=Tây%20Mỗ%2C%20Hà%20Nội%2C%20Vietnam&t=&z=13&ie=UTF8&iwloc=&output=embed" 
                width="600" 
