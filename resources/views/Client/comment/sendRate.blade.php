...
@section('content')
    <div class="max-w-screen-xl mx-auto ">
                            ...
                            <table class="table-auto w-full border-collapse border border-gray-300">
                                ...
                                <tbody>
                                    <tr class="hover:bg-gray-100">
                                        <td class="px-4 py-2 border border-gray-300 text-center" style="max-width:130px;">
                                            {{ $variant->product->code }}</td>
                                        ...
                                        <td class="px-4 py-2 border border-gray-300 text-center">{{ $variant->color->name }}
                                        </td>
                                        <td class="px-4 py-2 border border-gray-300 text-center">{{ $variant->size->name }}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <script>
            ...
            }, 5000); // Thời gian hiển thị thông báo 2 giây
        </script>
