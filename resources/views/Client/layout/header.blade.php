...
<body>
    ...
    <div class="max-w-screen-xl mx-auto ">
        <div class="header">
            <nav class="flex items-center justify-between">
                <div class="flex items-center space-x-8">
                    <div class="">
                        <a href="/">
                            <img src="{{ asset('assets/admin/img/Datch.png') }}" alt="" width="50px"
                                class="mb-1">
                        </a>
                    </div>
                ...
                <div class="flex items-center space-x-4">
                    <form action="{{ route('search') }}" method="GET">
                        <div class="relative">
                            <input type="text" placeholder="Tìm kiếm"
                                ...
                                id="search-box" name="query" autocomplete="off">
                            <button type="submit">
                                <i
                            ...
                            <div id="suggestions"
                                class="absolute bg-white border border-gray-200 rounded-lg mt-1 w-full max-h-60 overflow-y-auto z-10 hidden">
                            </div>
                        </div>
                    </form>
                    ...
                    @if (Auth::check())
                        <div class="relative group menucha">
                            <!-- User profile link -->
                            <a href="/tai-khoan" class="flex items-center text-gray-800 group"
                                class="group-hover:opacity-100 group-hover:block opacity-0 hidden">
                                <img src="{{ Auth::user()->avatar ? asset('uploads/' . Auth::user()->avatar) : asset('assets/client/images/no-avatar.svg') }}"
                                    alt="Avatar User" class="rounded-full w-8 h-8 mr-2">
                                <span class="text-sm">{{ Auth::user()->fullname }}</span>
                            </a>

                            <!-- Dropdown Menu -->
                            <div
                                class="menu absolute left-0  w-48 bg-white shadow-lg rounded-lg z-20 opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-hover:block hidden">
                                <ul class="py-2">
                                    <li><a href="/tai-khoan"
                                            class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fal"
                                                data-icon="user-circle"
                                                class="overflow-hidden svg-vertical inline-block w-[14px] h-[14px]"
                                    ...
                                    <li class="flex items-center">
                                        <a href="/notifications"
                                            class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100 flex items-center space-x-1">
                                            <i class="fa-regular fa-bell"></i>
                                            <span>Thông báo</span>
                                        </a>
                                        @if (isset($unreadNotificationsCount) && $unreadNotificationsCount > 0)
                                            <span
                                                class="text-xs font-semibold text-red-500 bg-red-200 rounded-full px-2 py-1 ml-1">
                                    ...
                                    <li><a href="/account/orders"
                                            ...
                                            <svg aria-hidden="true" focusable="false" data-prefix="fal"
                                                ...
                                                class="overflow-hidden svg-vertical inline-block w-[15.75px] h-[14px]"
                                                role="img" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 576 512">
                                                <path fill="currentColor"
                                    ...
                                    <li><a href="Danh-gia-cua-toi"
                                            class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fal"
                                                data-icon="star"
                                                class="w-[15px] h-[14px] overflow-hidden svg-vertical inline-block mr-2.5"
                                                role="img" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 576 512">
                                                <path fill="currentColor"
                                    ...
                                    <div class="mx-[15px] my-[20px] mb-[20px] text-[#333] text-[16px] font-bold">Cài
                                        đặt</div>
                                    <li><a href="/tro-giup"
                                            class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fal"
                                                data-icon="question"
                                                class="overflow-hidden svg-vertical inline-block w-[10.5px] h-[14px]"
                                                role="img" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 384 512">
                                                <path fill="currentColor"
                                    ...
                                    <li><a href="{{ route('Client.account.logout') }}"
                                            class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fal"
                                                data-icon="sign-out"
                                                class="w-[14px] h-[14px] overflow-hidden svg-vertical inline-block mr-2.5"
                                                role="img" xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 512 512">
                                                <path fill="currentColor"
                    ...
                    <a href="/gio-hang" class="flex flex-col items-center text-gray-800 relative">
                        <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="shopping-cart"
                            class="overflow-hidden svg-vertical inline-block w-[22.5px] h-[20px] text-[20px]"
                            role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                            <path fill="currentColor"
                                d="M551.991 64H129.28l-8.329-44.423C118.822 8.226 108.911 0 97.362 0H12C5.373 0 0 5.373 0 12v8c0 6.627 5.373 12 12 12h78.72l69.927 372.946C150.305 416.314 144 431.42 144 448c0 35.346 28.654 64 64 64s64-28.654 64-64a63.681 63.681 0 0 0-8.583-32h145.167a63.681 63.681 0 0 0-8.583 32c0 35.346 28.654 64 64 64 35.346 0 64-28.654 64-64 0-17.993-7.435-34.24-19.388-45.868C506.022 391.891 496.76 384 485.328 384H189.28l-12-64h331.381c11.368 0 21.177-7.976 23.496-19.105l43.331-208C578.592 77.991 567.215 64 551.991 64zM240 448c0 17.645-14.355 32-32 32s-32-14.355-32-32 14.355-32 32-32 32 14.355 32 32zm224 32c-17.645 0-32-14.355-32-32s14.355-32 32-32 32 14.355 32 32-14.355 32-32 32zm38.156-192H171.28l-36-192h406.876l-40 192z">
                            </path>
                        </svg>
                        <span class="absolute bottom-3 left-3 bg-red-600 text-white text-xs rounded-full px-1">
                            {{ $totalCart }} </span>
                    </a>
                </div>
            </nav>
        ...
        <div id="loading-overlay">
            <img src="{{ asset('assets/admin/img/logDatch.png') }}" alt="" width="300px"
                id="loading-logo">
        </div>
